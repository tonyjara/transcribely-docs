...
Go to the [webhooks section](https://dashboard.stripe.com/test/webhooks) click the **add local listener** button and follow the instructions.
...
![portal](/assets/customer-portal.jpeg)
