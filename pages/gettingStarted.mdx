...
Inside the **Constants.ts** file you can change all the site data to match your branding and preferences.

- __Sitedata__: Is where you add your app info. Changes here will be reflected throughout the app. Including email templates, hero, privacy policy and terms of service. After updating the constants to match your app's name, also update your app name in the site.webmanifest.json

- __AppOptions__: Depending on what options you choose here, the **env.mjs** file will require different variables.
